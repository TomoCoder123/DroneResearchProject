...
class WallFollowing():
    ...
    def __init__(self, reference_distance_from_wall=0.0,
        ...
        self.wall_following_direction_value = wall_following_direction
    ...
    def wall_follower(self, front_range, side_range, current_heading,
        ...
        self.wall_following_direction_value = float(wall_following_direction)
        ...
        if self.state == self.StateWallFollowing.FORWARD:
            ...
            print("command vel y temp: " + str(command_velocity_y_temp)+ " command angle rate temp: "+ str(command_angle_rate_temp))
